    ...
    <div class="container">
        <table class ="table table-hover table-bordered">
            ...
            <tr>
                ...
                <td><img src="project/admin/img/<?php=$result['book_image']?>" width="200px" height="250"> </td>
                
                <td><a href="editbook.php?UserID=<?php echo $result["book_ID"];?>">
