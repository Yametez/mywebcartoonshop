...
<td width="240"><input type="amount" class="form-control" name="amount" 
value="<?php echo $result["amount"]; ?>"></td> 
<!--value= คือการเรียกข้อมูลขึ้นมาแสดงเพื่อแก้ไข-->
</tr>
<tr>
<th width="150">รูปภาพ</th>    
<td width="240"><input type="file" class="control" name="book_image" required><?php echo $result["book_image"]; ?></td>
<!--value= คือการเรียกข้อมูลขึ้นมาแสดงเพื่อแก้ไข -->
</tr> 
</table>
