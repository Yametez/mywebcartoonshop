...
<html lang="en">
    <head>
        ...
        <title>รายงานการซื้อหนังสือ Admin</title>
                ...
                <main>
                    <div class="container-fluid px-4 ">
                        <div class="alert alert-primary h4 text-center mt-4" role="alert">
                            <!--h4 ขนาดตัวอัษร  
                            text-center ปรับให้อยู่จุดกึงกลาง
                            mt-4 ช่องไฟระหว่างขอบบน-->
                        รายงานการขายหนังสือ
                        </div>                        
            <div>
...
<br>            
                        ...
                        <div>
<form name="form1" method="post" action="report_orderlist_sell.php">
<div class="row">
    <div class="col-sm-2">
...
?>
                                ...
                                <div><b>รวมเป็นเงินทั้งหมด <?=number_format($total_sum,2)?> บาท</b></div>
                            </div>
                        </div>
                    </div>
                </main>
